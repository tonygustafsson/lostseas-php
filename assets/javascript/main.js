...
function gameManipulateDOM(data) {
	var x;
	var toggleVisibility = ["inventory_ship_health", "inventory_rafts", "inventory_crew_mood", "inventory_prisoners", "inventory_porcelain", "inventory_spices", "inventory_silk", "inventory_medicine", "inventory_tobacco", "inventory_rum", "inventory_bank_account", "inventory_bank_loan", "inventory_new_messages"];
	...
	$.ajax({
		...
		success: function(data) {
			...
			if (typeof(ga) == typeof(Function)) {
				ga('send', 'pageview', aURL.pathname);
			}
		},

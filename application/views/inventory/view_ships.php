...
<table>
	...
	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/shipyard_fixings.png" alt="Cannons" width="24" height="24"> Total cannons</td>
		<td><?=$player['game']['cannons']?> pcs</td>
	</tr>
	
	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/shipyard_fixings.png" alt="Cannons" width="24" height="24"> Manned cannons</td>
		<td><?=$player['game']['manned_cannons']?> pcs</td>
	</tr>

	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/raft.png" alt="Cannons" width="24" height="24"> Rafts</td>
		<td><?=$player['game']['rafts']?> pcs</td>
	</tr>
	
	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/cityhall_prisoners.png" alt="Prisoners" width="24" height="24"> Prisoners</td>

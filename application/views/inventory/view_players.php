		...
		<tr id="player_<?php echo $this_player['id']?>">
			<td width="40">
				<? if (file_exists(APPPATH . '../assets/images/profile_pictures/' . $this_player['id'] . '_thumb.jpg')): ?>
					<img width="40" height="40" src="<?php echo APPPATH . '../assets/images/profile_pictures/' . $this_player['id'] . '_thumb.jpg'?>" alt="<?php echo $this_player['name']?>">
				<? else: ?>
					<img width="40" height="40" src="<?php echo APPPATH . '../assets/images/profile_pictures/nopic_thumb.jpg'?>" alt="<?php echo $this_player['name']?>">
				<? endif; ?>
			</td>
			...
			<td><span<?echo (($this_player['last_activity_unix'] > (time() - 500)) ? ' style="color: #0FB308"' : '')?>><?php echo substr($this_player['last_activity'], 0, -3)?></span></td>
		</tr>
	<? endforeach; ?>
</table>

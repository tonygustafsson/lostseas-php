...
<header class="area-header" class="area-header" title="Inventory: Crew">
...
<form id="crew_form" class="ajaxJSON" method="post"
	...
	<table style="padding-bottom: 30px;">
		...
		<tr id="crew_<?=$man['id']?>">
			...
			<td><span
					id="crew_doubloons_<?=$man['id']?>"><?=$man['doubloons']?></span> dbl
			</td>
			<td><span
			...
			<td><span
					id="crew_health_<?=$man['id']?>"><?=$man['health']?></span> %</td>
		</tr>
		<?php endforeach; ?>

...
<div style="float: left; width: 10%; padding: 2em;">
	<img style="border: 1px black solid;" src="<?=$player['user']['profile_picture']?>" alt="<?=$player['user']['name']?>">
</div>
...
<div style="float: left; width: 10%; padding: 2em;">
	<img style="border: 1px black solid;" src="<?=$player['game']['character_avatar_path']?>" alt="<?=$player['game']['character_name']?>">
</div>
...
<div style="float: left; width: 75%; padding: 1em; clear: right;">
	<table id="inventory" style="padding-bottom: 2em;">
		...
		<?php if ($player['game']['place'] == 'ocean'): ?>
			<td>Caribbean Sea</td>
		<?php else: ?>
			<td><?=ucwords($player['game']['town_human']) . ' ' . $player['game']['place']?> (<?=ucfirst($player['game']['nation'])?>)</td>
		<?php endif; ?>
		</tr>
...
<table id="money" style="padding-bottom: 2em;">
	...
	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/bank.png" alt="Money" width="24" height="24"> Doubloons (Cash)</td>
		<td><?=$player['game']['doubloons']?> dbl</td>
	</tr>

	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/money_bank.png" alt="Money in bank" width="24" height="24"> Bank account</td>
		<td><?=$player['game']['bank_account']?> dbl</td>
	</tr>

	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/money_bank_loan.png" alt="Bank loan" width="24" height="24"> Bank loan</td>
...
<table id="stock" style="padding-bottom: 2em;">
	...
	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/market_browse.png" alt="Food" width="24" height="24"> Food</td>
		<td><?=$player['game']['food']?> cartons</td>
	</tr>

	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/water.png" alt="Water" width="24" height="24"> Water</td>
		<td><?=$player['game']['water']?> barrels</td>
	</tr>

	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/porcelain.png" alt="Porcelain" width="24" height="24"> Porcelain</td>
		<td><?=$player['game']['porcelain']?> cartons</td>
	</tr>

	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/spices.png" alt="Spices" width="24" height="24"> Spices</td>
		<td><?=$player['game']['spices']?> cartons</td>
	</tr>

	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/silk.png" alt="Silk" width="24" height="24"> Silk</td>
		<td><?=$player['game']['silk']?> cartons</td>
	</tr>

	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/tobacco.png" alt="Tobacco" width="24" height="24"> Tobacco</td>
		<td><?=$player['game']['tobacco']?> cartons</td>
	</tr>

	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/rum.png" alt="Rum" width="24" height="24"> Rum</td>
		<td><?=$player['game']['rum']?> barrels</td>
	</tr>

	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/medicine.png" alt="Medicine" width="24" height="24"> Medicine</td>
...
<table id="inventory" style="padding-bottom: 2em;">
	...
	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/flag-england.png" alt="Flag" width="24" height="12"> England</td>
		<td><?=$player['game']['victories_england']?> victories</td>
	</tr>
	
	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/flag-france.png" alt="Flag" width="24" height="12"> France</td>
		<td><?=$player['game']['victories_france']?> victories</td>
	</tr>
	
	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/flag-holland.png" alt="Flag" width="24" height="12"> Holland</td>
		<td><?=$player['game']['victories_holland']?> victories</td>
	</tr>
	
	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/flag-spain.png" alt="Flag" width="24" height="12"> Spain</td>
		<td><?=$player['game']['victories_spain']?> victories</td>
	</tr>
	
	<tr>
		<td><img src="<?=base_url()?>assets/images/icons/flag-pirate.png" alt="Flag" width="24" height="12"> Pirates</td>
		<td><?=$player['game']['victories_pirates']?> victories</td>
	</tr>

	<tr>
		<td></td>
		<td><?=$player['game']['total_victories']?> victories total</td>
	</tr>

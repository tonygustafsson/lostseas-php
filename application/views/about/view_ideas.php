...
<form class="ajaxJSON" id="form_suggestion" method="post" action="<?php echo base_url('about/send_suggestion')?>">
	<fieldset>
		<legend>Suggest a feature</legend>
		
		<label for="your_name">Name</label>
		<input type="text" name="name" id="name">
		<input type="text" id="your_name" name="your_name" value="<?php echo (isset($user['name'])) ? $user['name'] : ''; ?>">

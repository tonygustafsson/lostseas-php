...
<p style="text-align: center;">
	<img src="<?=base_url()?>assets/images/spanish_main.jpg" alt="Spanish main" style="margin: 20px 10px 10px 20px; border: 3px solid rgb(163, 162, 126);">
</p>
...
<p>Time is measured in weeks in <?=$this->config->item('site_name')?>. The time won't go by itself, but depends on your activity in the game.
...
<p style="text-align: center;">
	<img src="<?=base_url()?>assets/images/design/about_attack.jpg" alt="Attack" style="margin-top: 10px; margin-bottom: 10px; border: 3px solid rgb(163, 162, 126);">
</p>
...
<p style="text-align: center;">
	<img src="<?=base_url()?>assets/images/design/about_won.jpg" alt="Won" style="margin-top: 10px; margin-bottom: 10px; border: 3px solid rgb(163, 162, 126);">
</p>

...
<p>You can visit which of these you want, no matter which nationality you belongs to. This can change in the future...
</p>
...
<p>You will find ships from England, France, Spain and Holland. You will also find some pirates, these will always
	...
	as an ordinary attack. So you can lose. You will find more English ships around English towns, so if you want to get
	a higher level,
...
<p>I would suggest that you don't attack ships that have more cannons than you have. The is a random factor here, so you
	can win if the gap
	isn't to big. But it's really risky! It's the amount of functional cannons that decides if you will lose or not.</p>

<p>The fights aren't interactive yet, so you will directly see if you won or lost. You will get a report on how much you
	won or lost during
...
<p>Depending on how much food and water you are choosing to take, you pay this of with porcelain, spices and silk first,

...
<img src="<?echo base_url()?>assets/images/design/about_shop.jpg" alt="Shop" align="right" style="margin: 20px 20px 10px 10px; border: 3px solid rgb(163, 162, 126);">
...
<p style="text-align: center;">
	<img src="<?echo base_url()?>assets/images/design/about_rum.jpg" alt="Rum" style="margin-top: 10px; margin-bottom: 10px; border: 3px solid rgb(163, 162, 126);">
</p>

<?php if (! $logged_in): ?>
<header class="area-header" class="area-header" title="Guide: Players">
	<img class="area-header__img"
		src="<?=base_url('assets/images/design/game_start.jpg')?>"
		alt="Front image">
	<h2 class="area-header__heading">Guide: Players</h2>
...
<div class="container">
	...
	<p>The chat can be opened by clicking "Parley" at the top menu. It will open in a new windows so you can play and
		chat

...
<img src="<?=base_url()?>assets/images/design/about_shipyard.jpg"
	alt="Shipyard" align="left" style="margin: 20px 10px 10px 20px; border: 3px solid rgb(163, 162, 126);">

<p>If you lose in battle, and only have one ship you would have to swim to land with nothing at all (if you don't have
	any rafts).
...
<p>The second reason is that you will only lose part of your goods when loosing, if you have more than one ship. If you
	have three ships,
	you will lose one third of your goods. They will still take all your money though...</p>

<p>The third reason is that a ship can only hold so many crew members, cannons and load. If you want to get more money,
	higher titles,
	you will need more crew members and cannons. This is not possible with one ship.</p>

<p>When you start out as a pirate, you will only be able to own three ships. But as your rank get higher, you will be
...
<p>Cannons are needed for battles at sea. It's the amount of cannons that controls if you win or lose, and also how
	powerful ships
	you will meet. You will need two crew members to control one cannon, which means that if you have 20 cannons, and 30
	crew members,

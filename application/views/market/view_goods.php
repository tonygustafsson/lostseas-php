...
<div class="container">
	...
	<?php if ($game['doubloons'] < $game['event']['market_goods']['cost']): ?>
	<p id="offer">
		You find <?=$game['event']['market_goods']['quantity']?>
		cartons of <?=$game['event']['market_goods']['item']?>
		for <?=$game['event']['market_goods']['cost']?>
		dbl! (<?=$game['event']['market_goods']['item_cost']?>
		dbl/pcs) You don't have enough money though.
	</p>
	<?php else: ?>
	<div id="offer">
		<p>
			...
			for <?=$game['event']['market_goods']['cost']?>
			dbl! (<?=$game['event']['market_goods']['item_cost']?>
			dbl/pcs) Do you wan't to buy?
		</p>

		<div class="button-area">
			<a class="ajaxJSON button big primary"
				href="<?=base_url('market/goods_post/yes')?>"
				title="Yes please!">Yes</a>
			<a class="ajaxJSON button big"
				href="<?=base_url('market/goods_post/no')?>"
				title="I don't want your junk">No</a>
		</div>
	</div>
	<?php endif; ?>
</div>
...
<head>
	...
	<!--[if lt IE 10]>
		<link rel="stylesheet" href="<?php echo base_url('assets/stylesheets/ie.css?201309081542')?>" type="text/css" media="all">
	<![endif]-->
	...
	<!--[if lt IE 9]>
		<script type="text/javascript" src="<? echo base_url('assets/javascript/html5shiv.js')?>"></script>
	<![endif]-->

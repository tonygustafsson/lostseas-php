...
<?php if (isset($msg) && $looted_money !== null && $food !== null && $water !== null && $porcelain !== null && $spices !== null && $silk !== null && $medicine !== null && $tobacco !== null && $rum !== null && $new_crew !== null && $prisoners !== null && $sunken_ships !== null && $killed_crew !== null): ?>
	...
	<ul>
		<?php if ($looted_money > 0): ?>
			<li class="attack_good" style="list-style-image: url('<?=base_url()?>assets/images/icons/bank.png');">You looted <?=$looted_money?> doubloons.</li>
		<?php endif; ?>

		<?php if ($prisoners > 0): ?>
			<li class="attack_good" style="list-style-image: url('<?=base_url()?>assets/images/icons/cityhall_prisoners.png');"><?=$prisoners?> of the crew were known troublemakers, you take them in as prisoners.</li>
		<?php endif; ?>
	</ul>

	<ul>
		<?php if ($sunken_ships > 0): ?>
			<li class="attack_good" style="list-style-image: url('<?=base_url()?>assets/images/icons/coast.png');"><?=$sunken_ships?> of your ships sunk because of ship damages.</li>
		<?php endif; ?>

		<?php if ($killed_crew > 0): ?>
			<li class="attack_good" style="list-style-image: url('<?=base_url()?>assets/images/icons/tavern_sailor.png');"><?=$killed_crew?> of your crew members died in battle.</li>
		<?php endif; ?>
	</ul>

	<form method="post" class="ajaxJSON" id="won_form" action="<?=base_url('ocean/ship_won_transfer')?>">
		...
		<?php if ($new_crew > 0): ?>
			<fieldset>
				<legend><img src="<?=base_url()?>assets/images/icons/tavern_sailor.png" alt="Food" width="32" height="32"> Crew recruits</legend>
				...
				<div class="slider-container">
					...
					<table>
						<tr><td>Crew members</td><td><span id="crew_new_quantity_presenter" style="color: <?=($game['crew_members'] > $game['max_crew']) ? '#d52525' : '#000'; ?>;"><?=$game['crew_members']?></span> members</td></tr>
		...
		<?php if ($food > 0): ?>
			<fieldset>
				<legend><img src="<?=base_url()?>assets/images/icons/market_browse.png" alt="Food" width="32" height="32"> Food</legend>
				...
				<div class="slider-container">
					...
					<table>
						...
						<tr><td>Ship load</td><td><span class="load_total" style="color: <?=($game['load_current'] > $game['load_max']) ? '#d52525' : '#000'; ?>;"><?=$game['load_current']?></span> cartons</td></tr>
					</table>
				</div>
		...
		<?php if ($water > 0): ?>
			<fieldset>
				<legend><img src="<?=base_url()?>assets/images/icons/water.png" alt="Water" width="32" height="32"> Water</legend>
		...
		<?php if ($porcelain > 0): ?>
			<fieldset>
				<legend><img src="<?=base_url()?>assets/images/icons/porcelain.png" alt="porcelain" width="32" height="32"> Porcelain</legend>
		...
		<?php if ($spices > 0): ?>
			<fieldset>
				<legend><img src="<?=base_url()?>assets/images/icons/spices.png" alt="spices" width="32" height="32"> Spices</legend>
		...
		<?php if ($silk > 0): ?>
			<fieldset>
				<legend><img src="<?=base_url()?>assets/images/icons/silk.png" alt="silk" width="32" height="32"> Silk</legend>
		...
		<?php if ($medicine > 0): ?>
			<fieldset>
				<legend><img src="<?=base_url()?>assets/images/icons/medicine.png" alt="medicine" width="32" height="32"> Medicine</legend>
		...
		<?php if ($tobacco > 0): ?>
			<fieldset>
				<legend><img src="<?=base_url()?>assets/images/icons/tobacco.png" alt="tobacco" width="32" height="32"> Tobacco</legend>
		...
		<?php if ($rum > 0): ?>
			<fieldset>
				<legend><img src="<?=base_url()?>assets/images/icons/rum.png" alt="rum" width="32" height="32"> Rum</legend>

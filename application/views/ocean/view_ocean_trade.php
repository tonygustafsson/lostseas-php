...
<?php if ($trade_worth !== null): ?>
	...
	<form class="ajaxJSON" method="post" id="trade" action="<?=base_url('ocean/trade_transfer')?>">
		...
		<input type="hidden" name="load_barter_goods" id="load_barter_goods" value="<?=$game['porcelain'] + $game['spices'] + $game['silk'] + $game['medicine'] + $game['tobacco'] + $game['rum']?>">
		...
		<fieldset>
			...
			<div class="slider-container">
				...
				<table>
					...
					<tr><td>Trade worth</td><td><span class="trade_worth_left" style="color: <?=($trade_worth < 0) ? '#d52525' : '#000'; ?>;"><?=$trade_worth?></span> dbl</td></tr>

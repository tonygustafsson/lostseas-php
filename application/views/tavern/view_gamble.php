...
<form class="ajaxJSON" method="post" action="<?echo base_url()?>tavern/gamble_post">
	...
	<fieldset>
		<legend><img src="<?echo base_url()?>assets/images/icons/tavern_gamble.png" alt="Gamble" width="32" height="32"> Gamble with dices</legend>
		...
		<table style="margin: 0 auto; width: 90%">
			...
			<tr><td>Doubloons left if you lose</td><td><span class="money_left"><?echo $game['doubloons'] - $game['next_bet']?></span> dbl</td></tr>

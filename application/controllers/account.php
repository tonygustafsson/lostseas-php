...
class Account extends Main {
	...
	function register()
	{
		if ($this->user['user']['verified'] == 0)
		{
			...
			$months[1] = 'Jan'; $months[] = 'Feb'; $months[] = 'Mar'; $months[] = 'Apr';
	...
	function settings_account_post()
	{
		if ($this->user['user']['verified'] == 1)
		{
			//Validate form data
	...
	function settings_character_post()
	{
		if ($this->user['user']['verified'] == 1)
		{
	...
	function settings_password_post()
	{
	...
	function password_send_reset_link()
	{
